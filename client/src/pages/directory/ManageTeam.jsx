  ...
  if (memberName == "") {
    ...
    return (
      <div id="team-member">
        ...
        <button className="member-btn" id="view-profile">
          View Profile
        </button>
        <button className="member-btn" id="make-owner">
          Make Owner
        </button>
        <button className="member-btn" id="kick-member">
          Kick Member
        </button>
        <button className="member-btn" id="member-opt" onClick={toggleOptions}>
          Options<img src={Arrow}></img>
        </button>
  ...
  return (
    <div className="page">
      <div className="container">
        ...
        <h1 className="sm-team-name" id="sm-tn">
          Team Name:{" "}
        </h1>
        <h1 className="sm-team-name" id="sm-nm">
          {teamName}
        </h1>
